...
public class EmployeeServiceImpl implements EmployeeService{
    ...
    public Employee createEmployee (Employee employee) {
        ...
        //to copy employee model to employee entity
    ...
    public List<Employee> getAllEmployees() {
        ...
        List<Employee> employees = employeeEntities.stream().map( emp -> new Employee(emp.getId(), emp.getFirstName(), emp.getLastName(), emp.getEmail()))
